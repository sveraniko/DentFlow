...
DEFAULT_POLICY_VALUES: dict[str, object] = {
    ...
    "booking.upcoming_day_before_offset_hours": 24,
    "booking.same_day_reminder_offset_hours": 2,
    "booking.no_response_followup_enabled": True,
    "booking.no_response_followup_delay_minutes": 30,
    ...
    "booking.non_response_escalation_after_followup_minutes": 30,
